...
if (isset($_GET['id'])) {
    ...
    if ($result) {
        echo "<script>alert('User Deleted');window.location= 'users-account.php'</script>";
    } else {
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                <!-- /. ROW  -->
                <hr />
                <a href="user-add.php" class="btn btn-danger" style="margin-bottom: 10px;"><i class="fa fa-pencil"></i>ADD USER</a>
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="dataTables">
                                        ...
                                        <tbody>
                                            ...
                                            while ($result = mysqli_fetch_array($data)) {
                                                ...
                                                echo "<td>" . $result[1] . "</td>";
                                                echo "<td>" . $result[2] . "</td>";
                                                echo "<td>" . '<a href="user-update.php?id=' . $result['id'] . '">Update</a>' . "</td>";
                                                echo "<td>" . '<a href="users-account.php?id=' . $result['id'] . '">delete</a>' . "</td>";
