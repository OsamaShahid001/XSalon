...
if(isset($_POST["submit-btn"])){
    ...
    $result = mysqli_query($con, $query);
    if($result){
        echo "<script>alert('User Data Updated');window.location='users-account.php'</script>";
    }else{  
...
?>
    ...
    <div class="form-group input-group">
      <span class="input-group-addon"><i class="fa fa-user"></i></span>
        <input type="text" class="form-control" placeholder="Enter your Name" name="name" value="<?php echo $ename;?>" required>  
    </div> 
    <div class="form-group input-group">
      <span class="input-group-addon"><i class="fa fa-envelope"></i></span>
        <input type="text" class="form-control" placeholder="Enter your Email" name="email" value="<?php echo $eemail;?>" required>
    </div>
        <button name="submit-btn" class="btn btn-danger">Update</button>
        <a href="users-account.php" class="btn btn-danger">Back</a>
    </form>   
